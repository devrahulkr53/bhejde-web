...
export default function RegisterDriver() {
    ...
    useEffect(()=>{
        document.body.style.backgroundColor = "#dcd5ce";
        ...
        <div className="container">
            ...
            <div className="d-flex align-items-center">
                <div className="col-md-7 d-none d-md-block">
                    ...
                    <img src="/gif/become-driver.gif" width="75%" alt="" />
                ...
                <div className="col-md-5 p-0">
                    {isRegistered ? <div className="text-center my-3">
                        ...
                        <img src="/gif/become-driver.gif" width="100%" alt="" className='d-md-none' />

                        <form onSubmit={handleSubmit(onSubmit)} className="w-100 bg-white border shadow-lg p-3 rounded my-5">
                            ...
                            {!confirmationResult ? <>
                                ...
                                <div className="input-group my-2">
                                    <input type="text" className={`form-control`} id="vehicleRegNo" {...register("vehicleRegNo",{required:true,pattern:/^[A-Z]{2}[ -]{0,1}[0-9]{2}[ -]{0,1}[A-Z]{1,2}[ -]{0,1}[0-9]{1,4}$/})} placeholder="Vehicle registration number" />
                                    {errors.vehicleRegNo && <img src="/icons/danger.png" alt="error" width="20px" height="20px" className="my-auto" style={{position:"absolute",right:8,top:8,zIndex:20}} />}
                                </div>
                                ...
                                <select className={`form-select mb-2 ${errors.loadCapacity && 'border border-danger'}`} id="loadCapacity" {...register("loadCapacity",{required:true})}>
                                    <option value="">Select load capacity ( in tons ) </option>
